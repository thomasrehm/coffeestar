...
function displayPoints(points) {
    for (var i = 0; i < points.length; i++) {
        ...
        var marker = new google.maps.Marker({
            ...
            icon: iconPath,
            title: points[i].name,
            show: '../php/showcafe.php?kaffee_id='+points[i].kaffee_id,
            rate: '../php/bewertung.php?kaffee_id='+points[i].kaffee_id
        });
        ...
        google.maps.event.addListener(marker, 'click', function() {
            infoWindow.setContent(this.title+ '<br/><br/><a href="'+this.show+'" data-transition="slide"    > Café ansehen</a> <a href="'+this.rate+'"data-transition="slide"> Bewertung abgeben</a>');
